...
var _aos = __webpack_require__(2);

var _aos2 = _interopRequireDefault(_aos);

var _scrolly = __webpack_require__(4);

var _scrolly2 = _interopRequireDefault(_scrolly);

var _removeMobileHover = __webpack_require__(7);

var _removeMobileHover2 = _interopRequireDefault(_removeMobileHover);

var _wireSocialButtons = __webpack_require__(9);
...
var _scrollama = __webpack_require__(5);

var _scrollama2 = _interopRequireDefault(_scrollama);

var _stickyfilljs = __webpack_require__(6);
...
var scrolly = function scrolly() {
  ...
  (0, _scrollama2.default)().setup({
    ...
    (0, _dom.addClass)(element, 'scrolly-fade-in');
  }).onStepExit(function (_ref2) {
    var element = _ref2.element;

    (0, _dom.removeClass)(element, 'scrolly-fade-in');
  });
  ...
  (0, _scrollama2.default)().setup({
    ...
    (0, _dom.addClass)(element, 'move-in-right');
  }).onStepExit(function (_ref4) {
    var element = _ref4.element;

    (0, _dom.removeClass)(element, 'move-in-right');
  });
};
...
function wireSocialButtons(_ref) {
  ...
  var mailLink = 'mailto:?subject=' + encodedText + '&body=' + encodedText + '%0A%0A' + href;
  var mailNode = document.querySelectorAll(mail);

  for (var m = 0; m < mailNode.length; m += 1) {
    mailNode[m].setAttribute('href', mailLink);
  }

  var facebookLink = 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURI(href);
  var facebookNode = document.querySelectorAll(facebook);

  for (var f = 0; f < facebookNode.length; f += 1) {
    facebookNode[f].setAttribute('href', facebookLink);
  }

  var twitterLink = 'https://twitter.com/intent/tweet?text=' + encodedText + '&via=BostonGlobe&url=' + encodeURI(href);
  var twitterNode = document.querySelectorAll(twitter);

  for (var t = 0; t < twitterNode.length; t += 1) {
...
var active = (0, _dom.select)('.sidebar__list').getAttribute('data-active');
var opts = (0, _dom.selectAll)('.sidebar__list--item');
